...
var AccountConfigError, BadRequest, Message, NotFound, Process, SaveOrSendMessage, async, isDSAttachment, log, normalizeMessageID, ramStore, ref, simplebufferstream, stream_to_buffer, uuid,
  ...
  SaveOrSendMessage.prototype.attachNewBinaries = function(callback) {
    ...
    return async.eachSeries(Object.keys(this.newAttachments), (function(_this) {
      return function(name, next) {
        ...
        return _this.cozyMessage.attachBinary(stream, {
          name: name
        }, next);
      };
    })(this), callback);
