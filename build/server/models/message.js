...
var AccountConfigError, BadRequest, CONCURRENT_DESTROY, CONSTANTS, LIMIT_DESTROY, LIMIT_UPDATE, MSGBYPAGE, MailAdress, MailAttachment, Message, NotFound, _, async, cozydb, htmlToText, log, mailutils, ramStore, ref, simplebufferstream, uuid,
  ...
  Message.prototype.storeAttachments = function(attachments, callback) {
    ...
    return async.eachSeries(attachments, (function(_this) {
      return function(att, cb) {
        ...
        return _this.attachBinary(stream, {
          name: att.name
        }, cb);
      };
    })(this), callback);
